import{c,B as n,o as l}from"./index-DIIB83Nn.js";const t={class:"markdown-body"},r={__name:"02Union And Constraint",setup(i,{expose:o}){return o({frontmatter:{}}),(p,e)=>(l(),c("div",t,e[0]||(e[0]=[n(`<h1>学会使用 union 和 constraint</h1><p>在本教程中，我们将创建一个基于铅笔图片的柱状图。这个柱状图的特点是每个柱子由三部分组成：铅笔的顶部、中部和底部。我们将逐步解析代码，并解释每一步的作用。</p><h2>1. 准备数据</h2><p>首先，我们定义了一组数据，表示不同类别的数值：</p><pre><code class="language-typescript">const data = [
...
</code></pre><ul><li><code>union</code>：将铅笔图形和坐标轴合并为一个整体。</li><li><code>show</code>：将图形渲染到 <code>document.body</code> 中。</li></ul><h2>7. 最终效果</h2><p>运行以上代码后，你将看到一个基于铅笔图片的柱状图：</p><ul><li>每个柱子由铅笔的顶部、中部和底部组成。</li><li>柱子的高度由数据的 <code>amount</code> 字段决定。</li><li>x 轴显示类别，y 轴显示数值。</li></ul>`,29)])))}};export{r as default};
