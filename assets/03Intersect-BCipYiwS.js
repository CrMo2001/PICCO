import{c,B as d,o as t}from"./index-DINmjoDO.js";const a={class:"markdown-body"},i={__name:"03Intersect",setup(n,{expose:o}){return o({frontmatter:{}}),(r,e)=>(t(),c("div",a,e[0]||(e[0]=[d(`<h1>学习使用 intersect</h1><p>在本节教程中，我们将创建一个基于水位的人体图。这个图的特点是每个柱子由人体形状和水位矩形组成，水位的高度由数据决定。我们将逐步解析代码，并解释每一步的作用。</p><h2>1. 准备数据</h2><p>首先，我们定义了一组数据，表示不同类别的数值：</p><pre><code class="language-typescript">const data = [
