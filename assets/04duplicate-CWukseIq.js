...
</code></pre><ul><li><code>union</code>：将图形和 x 轴合并为一个整体。</li><li><code>show</code>：将图形渲染到 <code>document.body</code> 中。</li></ul><h2>9. 最终效果</h2><p>运行以上代码后，你将看到一个基于现金堆叠的图表：</p><ul><li>每个柱子由多个现金图片堆叠而成，堆叠的数量由数据的 <code>amount</code> 字段决定。</li><li>每个柱子顶部显示对应的数值标签。</li><li>x 轴显示类别。</li></ul>`,37)])))}};export{s as default};
