import{c,z as n,o as l}from"./index-CMeSIyLD.js";const t={class:"markdown-body"},r={__name:"02Combine And Constraint",setup(i,{expose:o}){return o({frontmatter:{}}),(p,e)=>(l(),c("div",t,e[0]||(e[0]=[n(`<h1>学会使用 combine 和 constraint</h1><p>在本教程中，我们将创建一个基于铅笔图片的柱状图。这个柱状图的特点是每个柱子由三部分组成：铅笔的顶部、中部和底部。我们将逐步解析代码，并解释每一步的作用。</p><h2>1. 准备数据</h2><p>首先，我们定义了一组数据，表示不同类别的数值：</p><pre><code class="language-typescript">const data = [
