import{_ as c}from"./human-ue3as4Cw.js";import{c as d,B as t,o as a}from"./index-DN5s-H94.js";const n={class:"markdown-body"},u={__name:"03Intersect",setup(l,{expose:o}){return o({frontmatter:{}}),(i,e)=>(a(),d("div",n,e[0]||(e[0]=[t('<h1>学习使用 intersect</h1><p>在本节教程中，我们将创建一个人体形状的柱状图。这个图的特点是每个柱子由人体形状和水位矩形组成，水位的高度由数据决定。我们将逐步解析代码，并解释每一步的作用 。 <img src="'+c+`" alt=""></p><h2>1. 准备数据</h2><p>首先，我们定义了一组数据，表示不同类别的数值：</p><pre><code class="language-typescript">const data = [
...
</code></pre><ul><li><code>show</code>：将图形渲染到 <code>document.body</code> 中。</li></ul><h2>7. 最终效果</h2><p>运行以上代码后，你将看到一个基于水位的人体图：</p><ul><li>每个柱子由人体形状和水位矩形组成。</li><li>水位的高度由数据的 <code>amount</code> 字段决定。</li><li>人体边框用于增强视觉效果。</li></ul>`,29)])))}};export{u as default};
