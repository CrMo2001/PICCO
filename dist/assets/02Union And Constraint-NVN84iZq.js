import{_ as c}from"./pencil-D1_Bb5i6.js";import{c as n,B as t,o as l}from"./index-DN5s-H94.js";const i={class:"markdown-body"},u={__name:"02Union And Constraint",setup(d,{expose:o}){return o({frontmatter:{}}),(a,e)=>(l(),n("div",i,e[0]||(e[0]=[t('<h1>学会使用 union 和 constraint</h1><p>在本教程中，我们将创建一个基于铅笔图片的柱状图。这个柱状图的特点是每个柱子由三部分组成：铅笔的顶部、中部和底部。我们将逐步解析代码，并解释每一步的作用。</p><p><img src="'+c+`" alt=""></p><h2>1. 准备数据</h2><p>首先，我们定义了一组数据，表示不同类别的数值：</p><pre><code class="language-typescript">const data = [
...
</code></pre><ul><li><code>xAxis</code>：x 轴，表示类别。</li><li><code>yAxis</code>：y 轴，表示数值。</li></ul><h2>6. 组合图形并渲染</h2><p>最后，我们将铅笔图形和坐标轴组合在一起，并使用 <code>show</code> 函数将其渲染到页面上。</p><pre><code class="language-typescript">const chart = union([collection, xAxis, yAxis])

show([[chart, data]], document.body, {})
</code></pre><ul><li><code>union</code>：将铅笔图形和坐标轴合并为一个整体。</li><li><code>show</code>：将图形渲染到 <code>document.body</code> 中。</li></ul><h2>7. 最终效果</h2><p>运行以上代码后，你将看到一个基于铅笔图片的柱状图：</p><ul><li>每个柱子由铅笔的顶部、中部和底部组成。</li><li>柱子的高度由数据的 <code>amount</code> 字段决定。</li><li>x 轴显示类别，y 轴显示数值。</li></ul>`,30)])))}};export{u as default};
